...
<div class="d-flex flex-items h-100 w-100 white-text pos-fix container">
    <h5>    <a href="{{route('welcome')}}" class="white-text tooltipped" data-tooltip="Back" data-delay="50"><i class="mx-5 fa fa-arrow-left"></i> &nbsp; </a>
        Are you sure you belong to AKGEC? If yes, then go back, else exit.</h5>

</div>


<div class="footnote text-capitalize green-text text-lighten-2">
    &copy; GreenBoard | 2020
</div>
