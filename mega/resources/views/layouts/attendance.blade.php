        ...
        <ul id="dropdown1" class="dropdown-content">
            ...
            <li><a href="{{ route('logout') }}"
                   onclick="event.preventDefault();
                            ...
                            class="fa fa-power-off right"></i></a></li>
...
<div class="row">
    <footer class="col offset-m2 s12 m10">
        ...
        <div class="right-align py-5">
            &copy; 2020, OSS R&D Web Development Team.
        </div>
    </footer>
</div>
...
<aside class="side-navigation green hide-on-med-and-down">
    <ul>
        ...
        <li><a href="{{url('./managefaculty/create')}}">faculty</a></li>
    ...
    <ul>
        <a class="waves-effect waves-ripple" href="#"> <i class="fa fa-pencil-square-o"></i> update<i
                    class="fa fa-arrow-left right oh-here-is-a-back-button"></i></a>
        <li><a href="{{url('./updatestud')}}">Student</a></li>
        <li><a href="{{url('./managefaculty3')}}">Faculty</a></li>
        <li><a href="{{url('./subject')}}">subject</a></li>
        <li><a href="{{url('./attendance/edit')}}">Attendance</a></li>
        @if($category=='ADMIN')
            <li><a href="{{url('./addExam')}}">exam</a></li>
        @endif
        <li><a href="{{url('./marks/update')}}">marks</a></li>
    <!-- <li><a href="{{url('./assignrole')}}">assignrole</a></li> -->

        <li><a href='#' class='green darken-2 backwards'><i class='fa fa-arrow-left'></i>Go Back</a></li>
    </ul>
    <ul>
        <a class="waves-effect waves-ripple" href="#"> <i class="fa fa-trash-o"></i> delete<i
                    class="fa fa-arrow-left right oh-here-is-a-back-button"></i></a>
        <li><a href="{{url('/deletestud')}}">Student</a></li>
        <li><a href="{{url('./managefaculty2')}}">Faculty</a></li>
        <li><a href="{{url('./subject/deletesub')}}">subject</a></li>
        @if($category=='ADMIN')
            <li><a href="{{url('./del')}}">exam</a></li>
            <li><a href="{{url('./marks/delete')}}">marks</a></li>
        @endif
    ...
    <ul>
        ...
        <li><a href="{{url('./viewAssignRole')}}">AssignRole</a></li>
        <li><a href="{{url('./marks/view')}}">marks</a></li>

        @if($category=='ADMIN')
            <li><a href="{{url('./addExam')}}">exams</a></li>
        @endif
        <li><a href='#' class='green darken-2 backwards'><i class='fa fa-arrow-left'></i>Go Back</a></li>
    </ul>
    ...
    @if($category=='ADMIN')
        ...
        <ul>
            <a class="waves-effect waves-ripple" href="#"> <i class="fa fa-cogs"></i> Settings<i
                        class="fa fa-arrow-left right oh-here-is-a-back-button"></i></a>

            <li><a href="{{url('/BulkChangeStud')}}">ChangeBulk Student</a></li>
